...
const run = async () => {
  ...
  try {
    const collections = ['listings', 'categories', 'users'];
    ...
    await Listing.create([
      ...
      },
      {
        ...
        description:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Semper eget duis at tellus at. Cursus euismod quis viverra nibh cras pulvinar mattis nunc.',
        price: 90000,
      ...
      },
      {
        ...
        description:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Sed risus pretium quam vulputate dignissim suspendisse. Faucibus turpis in eu mi bibendum neque egestas. Convallis posuere morbi leo urna molestie at elementum eu facilisis.',
        price: 15200,
